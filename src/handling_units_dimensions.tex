...
\hline
Diagnostics           & Exact location    & Possibly later    & Later             & Exact location      \\
Flexible units        & Yes               & Yes               & No                & Yes                 \\
Flexible dimensions   & Yes               & Yes               & No                & Yes                 \\
Arrays with units     & No                & No                & Yes               & No (difficult)      \\
Units of variables    & Static            & Static            & Dynamic           & Dynamic (lifetime)  \\
Units of arguments    & Derived           & Static (?)        & Dynamic           & Derived             \\
Performance           & Compile-time      & Compile-time      & Affected          & Compile-time        \\
Programming effort    & Medium            & Large             & Medium            & Medium              \\
\end{tabular}
\end{table}
...
the source code but the rewards for using consistent and verifiable units far outweight that burden.
