...
silver bullet (cf. \ref{ExistingSolutions}). Examination of the publications on these solutions show several
...
According to the Syst\`eme Internationale amounts of a substance are to be expressed in \emph{moles}, the number of molecules or atoms
...
The variable \verb+temp+ is used first as a weigth ($M$) and then as a height ($L$). If the dimension of each variable were
